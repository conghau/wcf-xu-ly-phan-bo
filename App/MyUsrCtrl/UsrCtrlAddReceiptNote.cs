...
namespace App.MyUsrCtrl
{
    public partial class UsrCtrlAddReceiptNote : MyUserControl
    {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (!list.Any())
            {
                Utilities.ShowMessage("Không tìm thấy sản phẩm\n Làm ơn thực hiện lại!!!");
                //return;
            }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Utilities.ShowMessageError("Hãy chọn sản phẩm trong danh sách sản phẩm");
                    return;
                }
        ...
        private bool IsVaild()
        {
            ...
            {
                Utilities.ShowMessageError("Sai /Không hợp lệ.\nHãy kiểm tra lại");
                return false;
            }
            return true;
        }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Utilities.ShowMessageError("Làm ơn chọn 1 dòng");
                    return;
                }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                if (lstReceiptNoteDetail.SelectedItems.Count < 1)
                {
                    Utilities.ShowMessageError("Hãy chọn 1 dòng");
                    return;
                }

                if (Utilities.ShowQuestionMessage("Bạn có chắc chắn muốn xóa ?") == DialogResult.No) return;
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                Utilities.ShowMessageError("Chi tiết hóa đơn nhập chưa có giá trị");
                return;
            }
            try
            {
                ...
                else
                {
                    ...
                    {
                        Utilities.ShowMessageError("Chi tiết hóa đơn nhập bị sai");
                        return;
                    }
